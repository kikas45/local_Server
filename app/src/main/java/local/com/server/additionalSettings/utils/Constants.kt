...
class Constants {
    companion object {
        ...
        const val CLO = "CLO"
        const val USER = "USER"
        const val autoStartServer = "autoStartServer"

        const val SHARED_BIOMETRIC = "SHARED_BIOMETRIC"
        const val SEVER_POP_MESSAGE =  "Network not detected. The server requires a connection to your local network (Wi-Fi or Ethernet) to function properly. Please connect and try again."
        const val KEY_HIDE_BAR = "hide_maintenance_bar"
