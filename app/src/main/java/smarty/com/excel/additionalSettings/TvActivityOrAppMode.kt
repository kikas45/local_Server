...
import smarty.com.excel.additionalSettings.urlchecks.checkStoragePermission
import smarty.com.excel.additionalSettings.urlchecks.requestStoragePermission
import smarty.com.excel.additionalSettings.utils.Constants
import smarty.com.excel.additionalSettings.utils.Utility
import smarty.com.excel.databinding.ActivityTvOrAppModePageBinding
import smarty.com.excel.databinding.CustomGrantAccessPageBinding
import smarty.com.excel.databinding.CustomPopDisplayOverAppsBinding
import smarty.com.excel.databinding.CustomeAllowAppWriteSystemBinding
import smarty.com.excel.databinding.ProgressValidateUserDialogLayoutBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (alreadyGranted) {
            ...
            if (Utility.foregroundForSeverServiceClass(applicationContext)) {
                startActivity(Intent(this, DemoWebActivity::class.java))
                finish()

            } else {
                startActivity(Intent(this, DE_MO_202100::class.java))
                finish()
            }
